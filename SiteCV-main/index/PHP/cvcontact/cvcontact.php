...
<head>
    <meta charset="UTF-8" />
    <title>Maxime Derènes | CV & Contacts</title>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item text-danger" href="#">Fiche de contact & CV &nbsp <i
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#top" class="text-white text-decoration-none">CV & Fiche Contact</a></li>
                    </ul>
                </div>
            </div>
            <div class="mt-3">
