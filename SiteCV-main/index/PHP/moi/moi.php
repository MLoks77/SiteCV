...
<head>
    <meta charset="UTF-8" />
    <title>Maxime Derènes | Présentation</title>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item text-danger" href="#top">Qui suis-je ? &nbsp <i
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#top" class="text-white text-decoration-none">Qui suis-je ?</a></li>
